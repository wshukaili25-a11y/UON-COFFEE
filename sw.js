const CACHE_NAME='uonhub-pwa-v30-0-1';
const OFFLINE_URL='/offline.html';
const CORE_ASSETS=['/','/index.html','/offline.html','/manifest.webmanifest','/css/app.css?v=30.0.1','/css/ui-refresh-v24.css','/css/v30-mobile.css?v=30.0.1','/css/pwa.css?v=25.8.0','/js/core.js?v=30.0.1','/js/v20-experience.js?v=30.0.1','/js/pwa-init.js?v=25.8.0','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
