...
const PRECACHE = [
  ...
  '/js/useful-sites.js','/js/student-tools-ui-v47.js','/js/schedule-time-fix-v44.js','/js/schedule-profile-boot-v44.js','/js/schedule.js','/js/schedule-main.js','/js/schedule-ai-import.js','/js/schedule-image-generator-v66.js','/js/schedule-ai-applied-toast.js','/js/schedule-ai-sync-v54.js','/js/schedule-extras-v44.js',
