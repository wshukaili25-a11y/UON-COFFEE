const CACHE_NAME='uonhub-pwa-v25-7';
const OFFLINE_URL='/offline.html';
const CORE_ASSETS=['/','/index.html','/offline.html','/manifest.webmanifest','/css/app.css','/css/ui-refresh-v24.css','/css/pwa.css?v=25.7.0','/js/pwa-init.js?v=25.7.0','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
