...
const PRECACHE = [
  ...
  '/assets/uonhub-instagram-logo.svg','/assets/uonhub-logo-header-v1.svg','/assets/uonhub-logo-original-20260904.jpeg','/assets/whatsapp-official.svg','/assets/icons/icon-192.png','/assets/icons/icon-512.png'
];
