(()=>{if(window.__anjizReportsTimetableCommsRegV15)return;window.__anjizReportsTimetableCommsRegV15=1;
...
(async()=>{try{
const [reportCode,tt,comm,reg]=await Promise.all([
...
style('timetableV13-css',tt.css);style('commsV14-css',comm.css);style('registrationV15-css',reg.css);
const blob=new Blob([reportCode+'\n'+tt.js+'\n'+comm.js+'\n'+reg.js],{type:'text/javascript'}),url=URL.createObjectURL(blob);
...
window.__reportsV12CoreLoaded=1;window.__timetableV13Loaded=1;window.__commsV14Loaded=1;window.__registrationV15Loaded=1;
}catch(e){console.warn('ANJIZ V15 add-ons unavailable',e)}})()})();
