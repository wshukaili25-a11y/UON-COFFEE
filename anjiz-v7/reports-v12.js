(()=>{if(window.__anjizReportsTimetableCommsRegInstStudentV18)return;window.__anjizReportsTimetableCommsRegInstStudentV18=1;
...
(async()=>{try{
const [reportCode,tt,comm,reg,inst,sv,svfix]=await Promise.all([
...
style('timetableV13-css',tt.css);style('commsV14-css',comm.css);style('registrationV15-css',reg.css);style('instructorV16-css',inst.css);style('studentV18-css',sv.css);
const blob=new Blob([reportCode+'\n'+tt.js+'\n'+comm.js+'\n'+reg.js+'\n'+inst.js+'\n'+sv.js+'\n'+svfix.js],{type:'text/javascript'}),url=URL.createObjectURL(blob);
...
window.__reportsV12CoreLoaded=1;window.__timetableV13Loaded=1;window.__commsV14Loaded=1;window.__registrationV15Loaded=1;window.__instructorV16Loaded=1;window.__studentV18Loaded=1;
}catch(e){console.warn('ANJIZ V18 add-ons unavailable',e)}})()})();
