import {nextClass,currentAcademicPulse,formatClassTime} from './student-pulse.js?v=61.0.0';

function addStyle(){if(document.querySelector('link[data-home-student-pulse]'))return;const link=document.createElement('link');link.rel='stylesheet';link.href='/css/home-student-pulse.css?v=61.0.0';link.dataset.homeStudentPulse='1';document.head.append(link)}
...
function mount(){
 ...
 const klass=nextClass(),academic=currentAcademicPulse();
