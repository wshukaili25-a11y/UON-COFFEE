...
const services=[
 ...
 {feature:'ratings',url:'ratings.html',icon:'⭐',title:t('تقييمات الدكاترة','Instructor Ratings'),desc:t('شوف تقييمات الطلبة للدكاترة وشارك تجربتك.','See student ratings for instructors and share your experience.')},
 ...
 {feature:'useful-sites',url:'useful-sites.html',icon:'🔗',title:t('الروابط المهمة','Useful Links'),desc:t('روابط الجامعة والخدمات الأكاديمية المهمة في مكان واحد.','University and essential academic links in one place.')},
