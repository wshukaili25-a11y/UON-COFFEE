...
function showLoadError(error){
 ...
 if(itemsContainer)itemsContainer.innerHTML='<div class="group-empty">تعذر تحميل مجموعات الواتساب حاليًا. حاول تحديث الصفحة بعد قليل.</div>';
 toast('تعذر تحميل مجموعات الواتساب',true);
}
