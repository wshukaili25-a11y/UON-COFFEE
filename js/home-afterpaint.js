...
const runAfterPaint=()=>{
 ...
 idle(()=>{void Promise.allSettled([
  importQuiet('./runtime-guard.js?v=64.4.4','Runtime guard'),
  importQuiet('./pwa-init.js?v=64.4.4','PWA')
 ])},1400);
 ...
 const stageTwo=()=>{
  ...
  void Promise.allSettled([
   importQuiet('./v20-experience.js?v=64.4.4','Home experience'),
   importQuiet('./content-reports.js?v=64.4.4','Content reports')
  ]);
 };
 let started=false;
